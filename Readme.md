...
To solve this problem, I worked with a real-world telecom dataset and-
Cleaned and prepared both categorical and numerical data
Trained a Random Forest machine learning model
Evaluated the model using accuracy, precision, recall, and F1-score
Built a simple Streamlit web app to show how this model could be used in a real product setting
